...
const en = {
    ...
    hello: "Hello,",
    what_are_you_looking_for: "what are you looking for today? Please be as specific as possible so that I can best help you :)",
...
//   export default en;
  ...
  const fr = {
    ...
    hello: "Bonjour,",
    what_are_you_looking_for: "que cherchez-vous aujourd'hui ? N'hésitez pas à être le plus précis possible afin que je puisse vous aider au mieux :)",
