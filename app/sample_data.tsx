export const productDetails = {
  ...
  description:
    "This is a description of the featured product. It is very interesting and you should buy it!",
  imageUrl: "https://via.placeholder.com/640x480?text=Product+Image",
  images: [
